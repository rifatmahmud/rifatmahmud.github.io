(function (root, factory) {
    ...
    WhichBrowser.prototype = {
        initialize: function(options) {
            ...
            this.browser = new Browser({ channel: "Dev", stock: false, hidden: false, mode: "", type: "browser", name: "Chrome", version: new Version({ value: "58.0.3029.110", hidden: false }) });
this.engine = new Engine({ name: "Blink" });
